      ...
      >
        <header className="w-full pt-0">
          <div className="mx-auto w-full lg:w-[80%] xl:max-w-6xl flex max-[450px]:block sm:justify-between sm:mx-auto p-3 items-center text-[#DFFFFF]">
            <img
              ...
              className="w-10 h-10 max-[450px]:w-16 max-[450px]:h-16 max-[450px]:mx-auto"
              alt=""
            />
        ...
        <div className="w-[80%] mx-auto flex justify-start sm:justify-center mb-[15%] xl:max-w-6xl">
          <div className="max-w-md mt-12 p-2 text-[#DFFFFF]">
            ...
            <p className=" text-lg">
              We believe that true happiness is found in the act of giving. It's
              the simple, yet profound feeling that washes over you when you
              extend a helping hand, share your blessings, or make a positive
        ...
        <div className="h-full sm:h-[50%] xl:max-w-6xl p-2 items-end pb-2 w-full sm:w-[80%] mx-auto gap-y-7 sm:gap-y-4 gap-x-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 place-items-center text-white">
          ...
          <div className="max-w-xs min-h-full text-center bg-[#425F57]/70 border border-[#CFFF8D] rounded-3xl p-2">
            ...
            <p className="pb-2 text-sm">
              Together, we can create positive change, inspire hope, and spread
              kindness to every corner of the world. Join us today!
            </p>
            <NavLink to={"/aboutUs"}>
          ...
          <div className="max-w-xs min-h-full text-center bg-[#425F57]/70 border border-[#CFFF8D] rounded-3xl p-2">
            ...
            <p className="pb-2 text-sm">
              The warmth of your heart and the dedication you bring inspire us
              all. Your presence is a reminder that when we come together, we
              can light up the darkest corners of the world.
            </p>
          ...
          <div className="max-w-xs min-h-full text-center bg-[#425F57]/70 border border-[#CFFF8D] rounded-3xl p-2">
            ...
            <p className="pb-2 text-sm">
              With your kindness, you're not just extending a helping hand;
              you're reaching out with hope, compassion, and the promise of a
              brighter tomorrow.
            </p>
            <NavLink to={"/ourWork"}>
              <span className="flex justify-center">
          ...
          <div className="max-w-xs min-h-full text-center bg-[#425F57]/70 border border-[#CFFF8D] rounded-3xl p-2">
            ...
            <p className="pb-2 text-sm">
              Education has the power to ignite a thousand flames, and you are
              the spark. With your commitment to learning, you're not just
              opening doors; you're lighting up the path to a future filled with
              possibilities.
            </p>
            <NavLink to={"/donation"}>
              <span className="flex justify-center">
